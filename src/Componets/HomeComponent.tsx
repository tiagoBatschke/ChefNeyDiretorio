...
const HomeComponent:FunctionComponent<HomeComponentProps> =()=>{
    ...
    return ( 
      ...
      <div className='bg-[#FFF0D4]'>
        <div className='bg-[#FFF0D4] h-[65vh] lg:h-[65vh] w-[100%] lg:w-[60%] lg:ml-[20%] flex flex-col lg:flex-row items-center justify-evenly p-1'>
          <img src="./src/assets/Group9.png" className='text-[2rem] lg:h-[50rem] lg:w-[50rem] text-center font-bold'/>
