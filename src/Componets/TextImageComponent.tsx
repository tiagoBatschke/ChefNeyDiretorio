...
const TextImageComponent:FunctionComponent =()=>{
    ...
    <div className='bg-[#F0CD8C] h-[190vh] p-2 flex flex-col lg:flex-row items-center justify-evenly lg:h-[80vh]'>
