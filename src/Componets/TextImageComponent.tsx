...
const TextImageComponent:FunctionComponent =()=>{
    return ( 
    <>
    <div className='h-[3vh] bg-[#A5554D]  flex items-center justify-center'></div>
    <div className='bg-[#FFF0D4] h-[220vh] p-2 flex flex-col lg:flex-row items-center justify-evenly lg:h-[90vh]'>
